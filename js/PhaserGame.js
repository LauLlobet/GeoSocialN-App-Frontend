...
define(["phaser"], function (phaser) {
    ...
    PhaserGame.prototype.preload = function () {
        ...
        this.game.load.image('logo', '/OurTreeWeb/assets/treeTrunk2.png');
    ...
    PhaserGame.prototype.create = function () {
        ...
        var point= this.game.add.sprite(this.game.parent.coordX(0),this.game.parent.coordY(0), 'point');
        point.anchor.set(0.5);
        this.game.parent.resizeSprite(point);
        point= this.game.add.sprite(this.game.parent.coordX(360 ),this.game.parent.coordY( 640 ), 'point');
        point.anchor.set(0.5);
        this.game.parent.resizeSprite(point);
        point= this.game.add.sprite(this.game.parent.coordX(- 360 ),this.game.parent.coordY( 640 ), 'point');
        point.anchor.set(0.5);
        ...
        this.game.parent.resizeSprite(point);
        point= this.game.add.sprite(this.game.parent.coordX(- 360 ),this.game.parent.coordY(- 640 ), 'point');
        this.game.parent.resizeSpriteToSize(point,360,360);
